    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            <div className='flex flex-col items-center justify-center gap-y-4 p-4'>
                <h2 className='text-2xl md:text-3xl lg:text-4xl font-extrabold text-neutral-200'>
                    F1 2025 Calendar
                </h2>
                <p className='text-center text-md lg:text-lg max-w-3xl font-bold text-neutral-300'>
                    Know all the F1 races of the 2025 Grand Prix calendar
